        ...
        <div class="card">
          ...
          <form action="insercao_curso.php" method="GET">
            ...
            <div class="text">
              ...
              <input type="text" name="ds_curso" id="ds_curso" value="<?php echo $curso["ds_curso"]; ?>" required>
            </div>
            <div class="text">
              <label for="nr_carga_horaria">Carga Horária:</label><br>
              <input type="number" name="nr_carga_horaria" id="nr_carga_horaria" value="<?php echo $curso["nr_carga_horaria"]; ?>" required>
            </div>
            <div class="text">
              <label for="dt_inicio">Data de Início:</label><br>
              <input type="date" name="dt_inicio" id="dt_inicio" value="<?php echo $curso["dt_inicio"]; ?>" required>
            </div>
